...
/** An object to builds a command that implements the Example auto */
public class ExampleAutoBuilder implements PresetAutoBuilder {
  ...
  public Command getCommand(RobotContainer botContainer) {
    return new PrintCommand("Example Auto");
  }
