...
public class PresetAutoFactory {
  ...
  private Map<AutoPreset, PresetAutoBuilder> m_factoryMap =
      new HashMap<AutoPreset, PresetAutoBuilder>();

  /** Creates an instance of the factory */
  public PresetAutoFactory() {
    // Populate the factory
    m_factoryMap.put(AutoPreset.Example, new ExampleAutoBuilder());
  }

  public PresetAutoBuilder getAutoBuilder(AutoPreset autoType) {
