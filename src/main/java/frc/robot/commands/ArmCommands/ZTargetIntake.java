...
public class ZTargetIntake extends ParallelCommandGroup {
  ...
  public ZTargetIntake(RobotContainer botContainer,CommandSwerveDrivetrain swerve, ProcessedXboxController controller, CameraTarget target) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new IntakeNote(botContainer),
      new DriveWithZTargeting(swerve, controller, target)
    );
  }
}
