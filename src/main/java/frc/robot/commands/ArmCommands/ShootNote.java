  ...
  public ShootNote(
    ...
    switch (target) {
      ...
      case Speaker:
        ...
        break;
      case SpeakerReverse:
        flywheelPreset = FlywheelPreset.ShootNoteSpeakerReverse;
        pivotAngle = PivotPreset.ShootSpeakerReverse;
        break;
      case Trap:
      default:
        ...
        new SequentialCommandGroup(
            ...
            new ParallelRaceGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    new WaitUntilCommand(() -> flywheelReachedSpeed(flywheel, targetFlywheelRPM))
                        .withTimeout(5.0),
