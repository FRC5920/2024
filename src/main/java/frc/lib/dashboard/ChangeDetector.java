...
/** A class used to detect changes to a dashboard widget value */
public class ChangeDetector<V> {
  ...
  /**
   * Creates an instance of the object that will return true the first time hasChanged() is called.
   */
  ...
  /**
   * Creates an instance of the object that will optionally return true the first time hasChanged()
   * is called.
   */
